...
public class FileUploadThread extends Thread {
    ...
    private FileUploadThread(Builder builder) {
    ...
    public FileUploadThread upload() {
        start();
        return this;
    }
     ...
     * 强行终止文件下载
     */
    public FileUploadThread cancel() {
        interupted = true;
        return this;
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (listener != null)
                listener.onFail(e);
            Logger.d("FileUploadThread", "上传失败:" + e);
        }
    }
    ...
    public static final class Builder {
        ...
        private Builder(String urlStr, Map<String, String> parms, File uploadFile) {
            this.urlStr = urlStr;
            this.parms = parms;
        ...
        public FileUploadThread build() {
            return new FileUploadThread(this);
        }
    }
}
